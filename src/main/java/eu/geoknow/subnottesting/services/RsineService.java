...
public class RsineService extends SubscriptionNotificationService {

    private static final Logger LOGGER = Logger.getLogger(RsineService.class);

    private static RsineService instance;
    ...
    public static RsineService getInstance() {
	if (instance == null)
	    instance = new RsineService();
	return instance;
    }
	...
	LOGGER.info("Registering subscriptions (ttl|rdf|n3 files) from resources/"
		+ directory);
